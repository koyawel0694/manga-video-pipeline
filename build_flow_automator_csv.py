#!/usr/bin/env python3
"""
build_flow_automator_csv.py — Construct Google Flow Automator Max V3 production CSVs.
...
BLOCKS_DATA = [
    {
        ...
        "voice_ref": "Korean male street reporter",
        "beats": [
            {
                "time": "0s-1.5s",
                "label": "THE OPENING",
                "content": "wide establishing crane shot descending into a bustling Seoul shopping street plaza; STREET REPORTER (23yo Korean male, tailored charcoal-gray suit, white collared shirt, slim black tie, holding blue wireless broadcast microphone) stands center framing; handheld camera operator in black cap films him in foreground; daylight 5600K ambient city reflections",
                ...
                "vo": '(Street Reporter): "(energetic, crisp broadcast projection) Natanong mo na ba sa sarili mo kung ano ang gagawin mo pag nagkapera ka bigla?"',
            ...
            },
            {
                ...
                "vo": '(Street Reporter): "(dramatic, teasing, eyes wide) Paano kung bigla kang magkaroon ng isang daang milyong won?"',
            ...
            },
            {
                ...
                "vo": '(Shin Yuri): "(playful, confident chuckle) Isang daang milyon? Kulang pa yan pambili ng sariling bahay..."',
            ...
            },
            {
                ...
                "vo": '(Street Reporter): "(probing, rapid-fire) Kotse? Negosyo? O itatabi mo lang sa bangko?"',
            ...
            },
            {
                ...
                "vo": '(Street Reporter): "(low, conspiratorial, leaning in) Huling tanong... Paano kung ikaw ang maging pinakamayamang tao sa buong mundo?"',
            ...
            },
            {
                ...
                "vo": '(Shin Yuri): "(sharp, witty smile) Bago ko sagutin yan... sabihin mo muna kung paano ako magiging ganoon kayaman." · END ON A COMPLETE FREEZE FRAME: Shin Yuri holds her confident smile and locked gaze through 10s, zero extra movement.',
    ...
    },
    {
        ...
        "voice_ref": "Korean male billionaire and female host",
        "beats": [
            {
                "time": "0s-1.5s",
                "label": "THE INTERVIEW",
                ...
                "vo": '(Female Interviewer): "(poised, measured respect) Ikaw ang pinakabata at unang Koreano na naging pinakamayaman sa mundo."',
            ...
            },
            {
                ...
                "vo": '(Female Interviewer): "(low, intriguing tone) May mga kumakalat na balita... na nakikita mo raw ang hinaharap. Isa ka raw clairvoyant."',
            ...
            },
            {
                ...
                "vo": '(Kang Jin-Hoo): "(calm, smooth, gentle chuckle) Nakikita ang hinaharap? Walang ganoong bagay. Isa lang akong simpleng investor."',
            ...
            },
            {
                ...
                "vo": '(Kang Jin-Hoo): "(internal voice, breathless gasp) ...Ang mata ko. Umiilaw na naman."',
            ...
            },
            {
                ...
                "vo": '(Spirit Shaman): "(ancient, dual-layered spectral voice) Nakikita mo ang kapalaran... ngunit kaya mo ba itong baguhin?"',
            ...
            },
            {
                ...
                "vo": '(Kang Jin-Hoo): "(enigmatic, quiet confidence) ...Simpleng tao lang ako na marunong tumaya sa tamang oras." · END ON A COMPLETE FREEZE FRAME: Kang Jin-Hoo holds his locked smirk and unwavering gaze into the lens through 10s.',
    ...
    },
    {
        ...
        "voice_ref": "Young discharged veteran and geeky best friend",
        "beats": [
            {
                "time": "0s-1.5s",
                "label": "THE WAKING",
                ...
                "vo": '(Kang Jin-Hoo): "(groggy, heavy sigh) Ilang linggo na mula nung na-discharge ako sa militar... pero masakit pa rin ang ulo ko."',
                "sfx": "distant street traffic outside window, rustle of coarse cotton bedsheets",
            },
            {
                "time": "1.5s-3s",
                "label": "THE DISCHARGE CAP",
                "content": "close-up of Jin-Hoo picking up his black ROK military discharge service cap with embroidered insignia from a dusty shelf; he stares at it quietly, remembering the training accident that gave him the vision",
                "camera": "slow macro push-in on military insignia and calloused fingers, 50mm lens",
                "emotion": "somber contemplation, quiet resolve",
                "vo": '(Kang Jin-Hoo): "(whispering to himself) Ang aksidenteng yun sa kampo... doon nagsimula ang lahat."',
            ...
            },
            {
                ...
                "vo": '(Oh Taek-Gyu): "(breathless, shouting excitedly) Jin-Hoo! Gising ka na ba?! Hindi ka maniniwala sa nahanap ko!"',
            ...
            },
            {
                ...
                "vo": '(Oh Taek-Gyu): "(rapid-fire chatter) Naalala mo yung binili nating Bantcoin nung college bago ka pumasok sa militar? Yung pinagtawanan ng lahat?"',
            ...
            },
            {
                ...
                "vo": '(Oh Taek-Gyu): "(triumphant, conspiratorial whisper) Nahanap ko ang encryption key ng wallet natin. Jin-Hoo... buhay pa ang account natin!"',
            ...
            },
            {
                ...
                "vo": '(Kang Jin-Hoo): "(stunned, heart dropping) ...Bantcoin? Ilang libo ang binili natin noon?" · END ON A COMPLETE FREEZE FRAME: Jin-Hoo stares motionless at the key while Taek-Gyu freezes mid-laugh through 10s.',
    ...
    },
    {
        ...
        "voice_ref": "Two Korean young men realizing sudden wealth",
        "beats": [
            {
                "time": "0s-1.5s",
                "label": "THE LOGIN",
                ...
                "vo": '(Oh Taek-Gyu): "(nervous, gulping) Sandali lang... naglo-load na ang balance. Tingnan natin kung magkano na."',
            ...
            },
            {
                ...
                "vo": '(Oh Taek-Gyu): "(trembling whisper, voice cracking) Jin-Hoo... mali ba ang nakikita ko? O nasisira na ang screen ko?"',
            ...
            },
            {
                ...
                "vo": '(Kang Jin-Hoo): "(intense, calculating under breath) Tatlong libong coins... multiplied by current market valuation..."',
            ...
            },
            {
                ...
                "vo": '(Oh Taek-Gyu): "(screaming in manic disbelief) LABING TATLONG BILYON! 13.5 Billion Won! Bilyonaryo na tayo, Jin-Hoo!"',
            ...
            },
            {
                ...
                "vo": '(Oh Taek-Gyu): "(laughing and crying simultaneously) Sabihin mo sa akin na gising ako! Sampalin mo ako, Jin-Hoo! Totoo ba to?!"',
            ...
            },
            {
                ...
                "vo": '(Kang Jin-Hoo): "(deep, cold, resolute) ...Hindi to panaginip. Pero kailangan nating mag-ingat." · END ON A COMPLETE FREEZE FRAME: Jin-Hoo holds his cold penetrating stare while Taek-Gyu freezes holding the phone.',
    ...
    },
    {
        ...
        "voice_ref": "Young visionary with supernatural premonition",
        "beats": [
            {
                "time": "0s-1.5s",
                ...
                "vo": '(Kang Jin-Hoo): "(internal gasp, trembling) ...Nandito na naman siya! Ang agila ng hinaharap!"',
                "sfx": "blazing fire roar, rushing wind vortex, ethereal eagle cry",
            },
            {
                "time": "1.5s-3s",
                "label": "THE BURNING LETTERS",
                "content": "across the smoky sky within Jin-Hoo's trance, burning Korean characters and English text ignite in molten crimson embers: 'MOUNTAINHILL EXCHANGE' followed by a massive shattered padlock and the burning word 'BANKRUPTCY / ILLEGAL SHUTDOWN'",
                ...
                "vo": '(Spirit Shaman): "(haunting, reverberating spectral warning) Ang toreng pinagtitiwalaan ninyo... guguho bago lumubog ang araw."',
            ...
            },
            {
                ...
                "vo": '(Kang Jin-Hoo): "(panting, desperate grip) Taek-Gyu! Saang exchange nakalagay ang mga coins natin?! Saan?!"',
            ...
            },
            {
                ...
                "vo": '(Oh Taek-Gyu): "(stammering, confused, scared) S-Sa Mountainhill Exchange... pinakamalaking exchange sa bansa. Bakit, Jin-Hoo?!"',
            ...
            },
            {
                ...
                "vo": '(Kang Jin-Hoo): "(authoritative, commanding roar) I-liquidate mo lahat ngayon din! Ibenta mo lahat ng Bantcoin bago magtanghali!"',
            ...
            },
            {
                ...
                "vo": '(Kang Jin-Hoo): "(cold, deadly serious whisper) Magtiwala ka sa akin... mawawala lahat kung maghihintay ka pa." · END ON A COMPLETE FREEZE FRAME: Taek-Gyu freezes with trembling thumb over the button while Jin-Hoo glares down through 10s.',
    ...
    },
    {
        ...
        "voice_ref": "Catastrophic crypto crash and ultimate revelation",
        "beats": [
            {
                "time": "0s-1.5s",
                ...
                "vo": '(Oh Taek-Gyu): "(gasping, nervous exhales) Na-benta ko na! Na-transfer na sa bangko... pero Jin-Hoo, sigurado ka ba talaga?"',
            ...
            },
            {
                ...
                "vo": '(Oh Taek-Gyu): "(voice trembling, eyes widening) H-Ha? Hindi ma-load ang app... nag-crash ang servers ng Mountainhill?!"',
                "sfx": "harsh digital error glitch buzz, rising siren tone",
            },
            {
                "time": "3s-4.5s",
                "label": "THE NEWS BREAK",
                "content": "Taek-Gyu frantically switches to a live news stream on his laptop: a red breaking news ticker scrolls across the screen showing police cars outside Mountainhill headquarters: 'BREAKING: CEO FLEES COUNTRY — EXCHANGE SHUTDOWN'",
                ...
                "vo": '(News Anchor on Laptop): "(urgent breaking news report) Biglaang nagsara ang pinakamalaking crypto exchange... bilyon-bilyong pondo ng mga depositor, naglaho!"',
            ...
            },
            {
                ...
                "vo": '(Oh Taek-Gyu): "(shaking, whisper of utter disbelief) Nahulaan mo... alam mo na mangyayari to bago pa nangyari. Sino ka ba talaga, Jin-Hoo?!"',
            ...
            },
            {
                ...
                "vo": '(Kang Jin-Hoo): "(calm, deep, solemn whisper) Sinabi ko na sayo kanina, Taek-Gyu... Hindi lang to hula."',
            ...
            },
            {
                ...
                "vo": '(Kang Jin-Hoo): "(cold, chilling, triumphant delivery) Nakikita ko ang hinaharap. At simula pa lang ito." · END ON A COMPLETE FREEZE FRAME: Jin-Hoo locks his golden eye onto the lens, motionless through 10s, cliffhanger freeze.',
...
def format_full_block_prompt(block: dict) -> str:
    """Build the exact 10s multi-line prompt conforming to PROMPT_CONTRACT v3."""
...
def build_char_refs_csv(output_path: Path):
    """Build char_refs_investor.csv (cols: prompt,scene name) for Flow image queue."""
    chars = [
        (
...
def main():
    ...
    master_csv_path = out_dir / "master_investor_ch1.csv"
    ...
    print(f"\n[OK] Episode 1 Full Flow Automator CSV (6 Blocks): {episode_csv_path}")

    # 4. Also copy to standard series directory if present
